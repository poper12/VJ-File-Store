...
# Ask Doubt on telegram @KingVJ01
    ...
    CAPTION = """<b>📂 ғɪʟᴇɴᴀᴍᴇ : @shitnigga_bot{file_name}

⚙️ sɪᴢᴇ : {file_size}

Jᴏɪɴ [ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ](https://t.me/Manga_Campus_Chat)</b>""" 
...
# Ask Doubt on telegram @KingVJ01
    ...
    ABOUT_TXT = """<b>𝐇𝐢 𝐈'𝐦 𝐛𝐨𝐭 𝐰𝐨𝐫𝐤𝐢𝐧𝐠 𝐟𝐨𝐫 @𝐬𝐡𝐢𝐭𝐧𝐢𝐠𝐠𝐚_𝐛𝐨𝐭.

🤖 ᴍʏ ɴᴀᴍᴇ: {}
╭───────────────⍟
├🧑🏻‍💻 Dᴇᴠᴇʟᴏᴩᴇʀ : <a href=https://t.me/Aaru_2074>𝑨𝒂𝒓𝒖</a>
├📚 Lɪʙʀᴀʀy : <a href=https://docs.pyrogram.org>𝐏𝐲𝐫𝐨𝐠𝐫𝐚𝐦</a>
├📝 Lᴀɴɢᴜᴀɢᴇ : ʟᴀɴɢᴜᴀɢᴇ: <a href=https://www.python.org>𝐏𝐲𝐭𝐡𝐨𝐧𝟑</a>
├👥 sᴜᴘᴘᴏʀᴛ: <a href=https://t.me/shitnigga_bot>𝗔𝗱𝗺𝗶𝗻𝘀</a>
╰───────────────⍟
"""

    CABOUT_TXT = """<b>𝐇𝐢 𝐈'𝐦 𝐛𝐨𝐭 𝐰𝐨𝐫𝐤𝐢𝐧𝐠 𝐟𝐨𝐫 @𝐬𝐡𝐢𝐭𝐧𝐢𝐠𝐠𝐚_𝐛𝐨𝐭.</b>
